...
### Objective
To demonstrate preliminary information gathering about a target before taking action (such as conducting an investigation) by using four reconnaissance tools within the Kali Linux environment, for the purpose of a more effective and strategic planning prior to initiating the attack.
